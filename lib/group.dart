...
String _localhost() {
  if (Platform.isAndroid)
    return 'http://35.220.163.89:7878/getgroup';
            ...
            SafeArea(
              child: Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text("Group",style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          }, child: Text("Add New",style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold,color: Colors.black87),),)
                        ],
                      ),
                    )
                  ],
