      ...
      setState(() {
        if (Friends.length ==0){
          if(element['name'] == widget.id){
            Friends = [...Friends, ChatUsers(name: element['receiver'], messageText: ('✓✓ ${element['message']}'), imageURL: 'imageURL', time: 'Now')];
          }
          else{
            Friends = [...Friends, ChatUsers(name: element['name'], messageText: element['message'], imageURL: 'imageURL', time: 'Now')];
          }
        }
        else{
          int count=0;
